...
$desclink = get_field( 'opis_nad__linkiem' );
$desclinktwo = get_field( 'opis_nad__linkiem_two' );
if ($btnMain) {
                ...
                <div class="b-hero__col text-center">
                    ...
                    <div class="b-hero__buttons">
                        ...
                        <div class="single-btn">
                            <?php echo $desclink ? '<span>' . $desclink . '</span>' : false; ?>
                            <a class="btn-revers header-contact__btn" href="<?php echo esc_url( $btnMain_url ); ?>" target="<?php echo esc_attr( $btnMain_target ); ?>">
                                ...
                                <span><?php  echo   $btnMain_title  ;?></span>
                            </a>
                        </div>
                        <?php } ?>
